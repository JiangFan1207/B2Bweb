;(function($){
	...
	$.fn.ajaxSubmit=function(options){
		...
		options.success=function(data,status,xhr){
			...
			var fileAPI=feature.fileapi&&feature.formdata;log("fileAPI :"+ fileAPI);
			...
			for(var k=0;k<elements.length;k++)
				elements[k]=null;this.trigger('form-submit-notify',[this,options]);
				return this;
				...
				function fileUploadIframe(a){
					...
					io=$io[0];
					xhr={aborted:0,responseText:null,responseXML:null,status:0,statusText:'n/a',getAllResponseHeaders:function(){},getResponseHeader:function(){},setRequestHeader:function(){},abort:function(status){
						...
						if(s.complete)
							s.complete.call(s.context,xhr,e);}};g=s.global;
							...
							function cb(e){
								...
								if(xhr.aborted){
									log('upload aborted');status=null;
									}
								if(xhr.status){
				...
				$.fn.ajaxForm=function(options){
					...
					function captureSubmittingElement(e){
						var target=e.target;var $el=$(target);
